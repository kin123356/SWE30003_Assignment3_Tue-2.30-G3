class NotificationSystem:
    def send_order_confirmation(self, user_email, order_id):
        ...
        return f"Sending confirmation for Order: {order_id} to {user_email}"
    ...
    def send_shipment_notification(self, user_email, order_id, tracking_number):
        ...
        return f"Sending Shipment Notification for Order: {order_id} to {user_email} with Tracking Number: {tracking_number}"
